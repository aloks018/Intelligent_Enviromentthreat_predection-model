...
render_hero(
    ...
    summary=(
        ...
        "and an AI-assisted local risk briefing."
    ),
...
render_section(
    ...
    "Map",
    "Select any location to generate a local report with temperature, rainfall, wind, AQI, and assistant guidance.",
)
render_panel(
    "Map workflow",
    "Click a location, review generated indicators, then ask the assistant for environmental advice.",
)
...
if "loc" in st.session_state:
    ...
    if user_input:
        context = {"city": city, "aqi": aqi, "temp": temp, "rain": rain}
